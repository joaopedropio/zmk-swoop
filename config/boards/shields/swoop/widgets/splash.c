...
void render_splash_pixel(uint8_t x, uint8_t y, uint8_t offset_x, uint8_t offset_y) {
	...
	display_write(get_display(), initial_x, initial_y, &buf_desc_splash, buf_splash);
}
...
void print_splash(void) {
	...
	print_bitmap(buf_splash_snake, CHAR_S, 0, 124, snake_scale, snake_num_color, snake_bg_color, FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_N, 48, 124, snake_scale, snake_num_color, snake_bg_color, FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_A, 96, 124, snake_scale, snake_num_color, snake_bg_color, FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_K, 144, 124, snake_scale, snake_num_color, snake_bg_color, FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_E, 192, 124, snake_scale, snake_num_color, snake_bg_color, FONT_SIZE_4x6);
}
...
void buffer_splash_init() {
	...
	fill_buffer_color(buf_splash, buf_size_splash, 0x004eu);
}
